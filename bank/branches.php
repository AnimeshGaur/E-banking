...
<div id="toptabmenu">
    <ul id="nav">
     ...
     <h2>CHAIRMAN</h2>  
     <p>Mr. Animesh gaur</p><br/><br/>
     <h2>EXECUTIVE DIRECTOR</h2>  
     <p>Ms. Ananya joshi</p>
     
     </div></div>
         <div class="brcont"><h2>The bank of RDEC</h2><br/>Our branch in New York city is also popularly known as "The bank of RDEC", named after the legendary Iron Man. 
             As Tony Stark's newest financial institution, The bank of RDEC has a proud tradition of providing friendly, 
